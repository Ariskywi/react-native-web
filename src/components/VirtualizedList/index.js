...
import FillRateHelper from '../ListView/FillRateHelper';
import StyleSheet from '../../apis/StyleSheet';
import View from '../View';
import ViewabilityHelper from '../ListView/ViewabilityHelper';
import PropTypes,{ shape, bool, number, checkPropTypes } from 'prop-types';
...
import {computeWindowedRenderLimits} from '../ListView/VirtualizeUtils';
...
class VirtualizedList extends React.PureComponent<Props, State> {
     ...
     */
    getScrollResponder() {
        return this._scrollRef && this._scrollRef.getScrollResponder();
    }
    ...
    setNativeProps(props) {
        return this._scrollRef && this._scrollRef.setNativeProps(props);
    }
